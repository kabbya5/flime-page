...
<div class="pt-[72px] pb-[49px]">
    <div class="flex items-center justify-between">
        ...
        <button id="add_post_button" class="btn-gradient-pink">
            যোগ করুন
        </button>
    </div>
                ...
                <table class="w-full whitespace-nowrap">
                    <thead class="bg-gradient-red">
                        <tr>
                            ...
                            <th align="left" class="py-[18px] font-700 text-white text-[13px] leading-[18px]"> আইটেম টাইপ  </th>
                            <th align="left" class="py-[18px] font-700 text-white text-[13px] leading-[18px]"> প্রকাশের তারিখ  </th>
                            <th align="left" class="py-[18px] font-700 text-white text-[13px] leading-[18px]"> অবস্থা</th>
                            <th align="center"></th>
                        </tr>
                    </thead>
