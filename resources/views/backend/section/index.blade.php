...
<div class="pt-[72px] pb-[49px]">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.sections.create') }}" class="btn-gradient">
            যোগ করুন
        </a>
    </div>
                            ...
                            <tr tabindex="0" class="panding focus:outline-none border-t border-gray-200 rounded mt-[3px]">
                                <td>
                                    <div class="mx-5 flex text-center  py-[24px]">
                                        <p class="font-700 text-[14px] leading-[21px] text-black">{{$section->section_name }}</p>
                                    </div>
                                </td>
                                
                                <td class="text-left pr-10">
                                    <p class="font-[600] text-[14px] leading-[21px] text-[#8E8E93]">{{ $section->section_slug }} </p>
                                </td>
                                <td class="text-center">
                                    <p class="font-[600] text-[14px] leading-[21px] text-[#8E8E93]">{{ $section->subsections->count() }}</p>
                                </td>
                                <td class="text-left">
                                ...
                                <td class="text-center">             
                                    <div class="flex">
                                        ...
                                        <a href="{{ route('admin.sections.edit',$section->section_slug) }}" class="ml-4">
