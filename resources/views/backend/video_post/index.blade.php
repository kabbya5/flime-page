                                ...
                                <td style="width:10%" class="text-right px-1">             
                                    <div id="doropdown-toggoler" class="w-full pr-[22px] relative flex flex-col ">
                                        ...
                                        <div class="shadow-lg dropdown-items absolute hidden left-[-160px] top-[-10px]">
                                            <a href="{{ route('admin.video.posts.edit',$post->slug) }}" class="btn text-[#2518FF] border-b flex items-center capitalize font-[600] text-[18px] leading-7">
                                                <img src="{{ asset('media/icon/edit.png') }}" alt="" class="mr-[10px] h-[18px]"> edit
                                            </a>

                                            <a href="{{ route('admin.video.posts.duplicate',$post->slug) }}" class="btn border-1 text-[#565956] flex items-center capitalize font-[600] text-[18px] leading-7">
                                                <img src="{{ asset('media/icon/duplicate.png') }}" alt="" class="mr-[10px] h-[18px]"> duplicate
                                            </a>

                                            <form action="{{ route('admin.video.posts.destroy',$post->slug) }}" method="POST">
                                                @csrf
                                                @method("DELETE")
