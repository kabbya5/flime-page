...
<div class="form-group flex justify-between mt-10">
    ...
    <div class="flex justify-between w-1/2">
        <div id="video" class="hidden w-1/2 ml-2">
            ...
            @else
            <div class="w-32 h-20">
                <iframe src="https://www.youtube.com/embed/{{ $post->video_link }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            @endif
